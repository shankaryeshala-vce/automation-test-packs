...
def test_post_eval(sys, rcmid, train, version, type, model, identifier, fileName):
    ...
    while results < evals:
        if data['rcmEvaluationResults'][results]['evaluatedVersionDatum']['definition']['modelFamily'] == model and identifier in data['rcmEvaluationResults'][results]['evaluatedVersionDatum']['identity']['identifier']:
            if data['rcmEvaluationResults'][results]['evaluatedVersionDatum']['identity']['elementType'] == type:
                ...
                assert data['rcmEvaluationResults'][results]['elementUuid'] == data['rcmEvaluationResults'][results]['evaluatedVersionDatum']['componentUuid']
                assert type in data['rcmEvaluationResults'][results]['evaluatedVersionDatum']['identity']['serialNumber']
                assert data['rcmEvaluationResults'][results]['evaluatedRcmDatum']['productFamily'] == data['rcmEvaluationResults'][results]['evaluatedVersionDatum']['definition']['productFamily']
                assert data['rcmEvaluationResults'][results]['evaluatedRcmDatum']['product'] == data['rcmEvaluationResults'][results]['evaluatedVersionDatum']['definition']['product']
                ...
                assert data['rcmEvaluationResults'][results]['evaluatedVersionDatum']['versions'][0]['version'] == data['rcmEvaluationResults'][results]['actualValue']
                assert data['rcmEvaluationResults'][results]['evaluatedRcmDatum']['versions'][0] == data['rcmEvaluationResults'][results]['expectedValues'][0]
                assert data['rcmEvaluationResults'][results]['evaluatedVersionDatum']['deviceUuid'] == deviceID or deviceID2
                actual = data['rcmEvaluationResults'][results]['actualValue']
                expected = data['rcmEvaluationResults'][results]['expectedValues'][0]
                print('Component UUID:', data['rcmEvaluationResults'][results]['evaluatedVersionDatum']['componentUuid'])
