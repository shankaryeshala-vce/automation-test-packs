...
def load_test_data():
    ...
    messageVersion = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataVersion)
    messageTrain = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataTrain)
    messageModel = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataModel)
    messageFamily = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataFamily)
    messageInvalid1 = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataInvalid1)
    messageInvalid2 = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataInvalid2)
    messageInvalid3 = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataInvalid3)
    messageInvalid4 = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataInvalid4)
    messageInvalid5 = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataInvalid5)
    messageInvalid6 = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataInvalid6)
    messageInvalid7 = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataInvalid7)
    messageInvalid8 = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataInvalid8)
    messageVxRackVersion = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataVxRackVersion)
    messageVxRackTrain = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataVxRackTrain)
    messageVxRackModel = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataVxRackModel)
    messageVxRackFamily = af_support_tools.get_config_file_property(config_file=payload_file, heading=payload_header, property=payload_dataVxRackFamily)
...
def resetTestQueues(testRequest, testResponse):
    ...
    af_support_tools.rmq_bind_queue(host=host, port=port, rmq_username=rmq_username, rmq_password=rmq_password, queue='testListRCMDefinitionsRequest', exchange='exchange.dell.cpsd.rfds.rcm.definition.request', routing_key='#', ssl_enabled=False)
    af_support_tools.rmq_bind_queue(host=host, port=port, rmq_username=rmq_username, rmq_password=rmq_password, queue='testListRCMDefinitionsResponse', exchange='exchange.dell.cpsd.rfds.rcm.definition.response', routing_key='#', ssl_enabled=False)
...
def insertListRequest(payLoad, requestFile, responseFile):
    ...
    af_support_tools.rmq_publish_message(host=host, port=port, rmq_username=rmq_username, rmq_password=rmq_password, exchange="exchange.dell.cpsd.rfds.rcm.definition.request", routing_key="dell.cpsd.rfds.rcm.definition.request", headers=messageReqHeader, payload=payLoad, payload_type='json', ssl_enabled=False)
    time.sleep(2)
    my_request_body = af_support_tools.rmq_consume_message(host=host, port=port, rmq_username=rmq_username, rmq_password=rmq_password, queue='testListRCMDefinitionsRequest', ssl_enabled=False)
    my_response_body = af_support_tools.rmq_consume_message(host=host, port=port, rmq_username=rmq_username, rmq_password=rmq_password, queue='testListRCMDefinitionsResponse', ssl_enabled=False)
	...
	if ("rcms") in data.keys():
		...
		if numRCMs > 0:
			while i < numRCMs:
				...
				assert data["rcms"][i]["systemProductFamily"] == (dataInput["systemProductFamily"]), "Product does not match."
				i += 1
