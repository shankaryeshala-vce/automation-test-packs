...
def resetTestQueues(testRequest, testResponse, testCredentials):
    ...
    af_support_tools.rmq_purge_queue(host=host, port=port, rmq_username=uname, rmq_password=password, queue=testRequest,
                                     ssl_enabled=False)
    af_support_tools.rmq_purge_queue(host=host, port=port, rmq_username=uname, rmq_password=password,
                                     queue=testResponse, ssl_enabled=False)
    af_support_tools.rmq_purge_queue(host=host, port=port, rmq_username=uname, rmq_password=password,
                                     queue=testCredentials, ssl_enabled=False)
