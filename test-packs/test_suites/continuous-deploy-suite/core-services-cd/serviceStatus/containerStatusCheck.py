...
# Revision:
# Code Reviewed by:
# Description: Sanity check performed to Test dockerise services are running when the new OVA is deployed
################################################################################################
...
def test_servicerunning(service_name):
    ...
    service_name_pid = service_name.replace("symphony-","").replace("-service","")
...
@pytest.mark.parametrize("service_name, pid", [
    ...
    ("symphony-system-definition-service", "services/system-definition/"),
    ("symphony-hal-orchestrator-service", "services/hal-orchestrator/"),
    ("symphony-rcm-compliance-data-service", "services/rcm-compliance-data/"),
    ("symphony-rcm-definition-service", "services/rcm-definition/"),
    ("symphony-rcm-evaluation-service", "services/rcm-evaluation/"),
...
def test_servicestop_yml():
    ...
    sendCommand_yml_down = "docker-compose -f /opt/dell/cpsd/rcm-fitness/common/install/docker-compose.yml down"
...
def test_servicestart_yml():
    ...
    sendCommand_yml_up = "docker-compose -f /opt/dell/cpsd/rcm-fitness/common/install/docker-compose.yml up -d"
