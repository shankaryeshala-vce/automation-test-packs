...
def createCSPayload():
    ...
    # add_component_payload = '{"messageProperties":{"timestamp":"2017-02-06T10:52:48.964+0000","correlationId":"vxrack-abcd-abcd-abcd-abcdabcdabcd$97d1c4d9-d36b-401d-98f8-fbab89adbc43","replyTo":"sds.cullia81.mpe.lab.vce.com"},"componentUuid":"54b01cfc-49c7-3ead-9035-dab481d6c521","endpoints":[{"endpointUuid":"589051c8-40ba-3dcf-bd9f-43aadeaac9bf","credentials":[{"name":"ADMIN","credentialElement":{"username":"admin","password":"Vc3m0l@b"}}]},{"endpointUuid":"ac5f9152-c2f1-3d3c-bce8-7b6b59145e46","credentials":[{"name":"DEFAULT","credentialElement":{"community":"public"}}]}]}'
    af_support_tools.set_config_file_property(config_file='symphony-sds.ini', heading=payload_heading,
